...
angular.module('myApp').factory("FiveEToolsDataMapper", function (DataMapper, CreatureData) {
    ...
    class FiveEToolsDataMapper extends DataMapper {
        constructor() {
            super();
        }
