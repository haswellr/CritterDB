...
userCtrl.$inject = ["$scope", "User", "Bestiary", "Auth", "$location", "$mdMedia", "$mdDialog", "$mdToast"];
...
updateUserCtrl.$inject = ["$scope", "User", "Auth", "$location", "user"];
...
forgotPasswordCtrl.$inject = ["$scope", "User", "$mdDialog"];
